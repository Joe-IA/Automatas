...
int main(int argc, char **argv){
    ...
    manager.setFiles();
    char option,tInput, automataType;
    ...
    do{
        ...
        std::cout << "1. AFD - AFND\n";
        std::cout << "2. PDA\n";
        std::cout << "3. Máquina de Turing \n";
        std::cout << "Selecciona opcion: ";
        std::cin >> automataType;
        std::cin.ignore();
    } while(automataType != '1' && automataType != '2' && automataType != '3');
    ...
    while(true) {
        switch(automataType){
            ...
            case '3':
                std::cout << "---------- Menu ----------\n";
                std::cout << "1. Consumir TM\n";
                std::cout << "2. Mostrar notación\n";
                std::cout << "3. Insertar palabra\n";
                std::cout << "Para salir presione q\n";
                std::cout << "Seleccionar opcion: ";
                std::cin >> option;
                std::cin.ignore();
